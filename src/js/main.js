...
angular.module('app')
    .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', '$state', 'apiService', 'aclService',
        function($scope, $translate, $localStorage, $window, $state, apiService, aclService) {
