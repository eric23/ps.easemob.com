angular.module('app').directive('api', ['$compile', function($compile){
	return{
		replace: true,
		restrict: 'E',
		scope: true,
		controller: ['$scope', '$element', '$attrs', '$http', '$state', 'toaster', function ($scope, $element, $attrs, $http, $state, toaster) {
            ...
            function isParameter(name) {
            	return param = $scope.config.params[name];
            }
		...
		link: function(scope, elm, attrs, ctrl){
			scope.config.api.body.productType = 'aaa';
		},
...
.controller('DatepickerSimpleCtrl', ['$scope', function($scope){
